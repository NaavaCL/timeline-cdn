...
$(document).on('click', ".menu-item", function() {
    ...
    if (type == "main-menu") {
		...
		var inputWrapper = `<div class="color-input-wrapper"><label id="texto">HEX CODE:</label><input id="hexInput" type="text" value="Hex Code"></input></div>`;
        $("#item-wrapper").append(newItemDiv);
		$("#item-wrapper").append(inputWrapper);
